...
set_property -dict { PACKAGE_PIN C10   IOSTANDARD LVCMOS33 } [get_ports { Y[0] }]; #IO_L13N_T2_MRCC_16 Sch=sw[2]
set_property -dict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { Y[1] }]; #IO_L14P_T2_SRCC_16 Sch=sw[3]
...
set_property -dict { PACKAGE_PIN C9    IOSTANDARD LVCMOS33 } [get_ports { TOGGLE }]; #IO_L11P_T1_SRCC_16 Sch=btn[1]
